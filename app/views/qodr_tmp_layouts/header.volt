...
<html lang="en">
  <head>
    ...
    <!-- iCheck -->
    {{ stylesheet_link('vendors/iCheck/skins/flat/green.css') }}
    <!-- Custom Theme Style -->
    {{ stylesheet_link('css/custom.min.css') }}
    ...
    <!-- FastClick -->
    {{ javascript_include("vendors/fastclick/lib/fastclick.js") }}
    <!-- Custom Theme Scripts -->
    {{ javascript_include("build/js/custom.min.js") }}
